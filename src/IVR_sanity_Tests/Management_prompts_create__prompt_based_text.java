...
/**
* ----------------
* This test tests the Create-prompt using text mechanism
* -----------------
* Tests:
*    - Enter the Auto-Attendant section
*    1. Create a prompt using text
...
public class Management_prompts_create__prompt_based_text {
  ...
  public Management_prompts_create__prompt_based_text(String browser) {
  ...
  @Test
  public void Create_prompt_based_text() throws Exception {
	...
	// Create a prompt using text
	testFuncs.myDebugPrinting("Create a prompt using text", testVars.logerVars.MAJOR);

...
/**
* ----------------
* This test tests an export of IVR-endpoint records
* -----------------
* Tests:
*    - Enter the Auto-Attendant section
*    - Create an IVR-endpoint record
*    1. Enter the Import / Export menu and export the current IVR-endpoints.
*    2. Check that the created IVR-endpoint exists in the exported file.
*    3. Re-enter the IVR-endpoints menu and delete the created IVR-endpoint.
* 
* @author Nir Klieman
* @version 1.00
*/
...
public class Management_export_ivr_endpoints {
  ...
  public Management_export_ivr_endpoints(String browser) {
  ...
  @Test
  public void Export_IVR_endpoints() throws Exception {
	   
	  Log.startTestCase(this.getClass().getName());
	  String ivrNumber = "52990";
	  String expName   = "ExportIVREndpoints";
	  
	  testFuncs.myDebugPrinting("Login and create an IVR-endpoint", testVars.logerVars.MAJOR);
	  ...
	  // Enter the Import-Export menu and Export the IVR-endpoints
	  testFuncs.myDebugPrinting("Step 1 - Enter the Import-Export menu and Export the IVR-endpoints", testVars.logerVars.MAJOR);
	  ...
	  driver.findElement(By.xpath("//*[@id='IVRENDPOINT']/fieldset/table/tbody/tr[1]/td/a[1]")).click(); 
	  ...
	  // Re-enter the IVR-endpoints menu and delete the created IVR-endpoint
	  testFuncs.myDebugPrinting("Step 2 - Re-enter the IVR-endpoints menu and delete the created IVR-endpoint", testVars.logerVars.MAJOR);	
	  driver.switchTo().defaultContent();		
	  testFuncs.myClick(driver, By.xpath(testMenuPaths.aaManagementIvrEndPnts), 3000); 
	  driver.switchTo().frame(1);
